...
public class AugmentContributionTest extends TestCase{
    ...
    @Test
    public void testAugmentContribution() throws Exception {
        ...
        driver.findElement(By.name("value")).sendKeys("9950");
        driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
