...
public class SendMessageTest extends TestCase{
    ...
    public void testSendMessage() throws Exception {
        ...
        driver.findElement(By.xpath("//li[@id='privateMessages']/a/span")).click();
        driver.findElement(By.linkText("Show all conversations")).click();
        driver.findElement(By.linkText("NEW MESSAGE")).click();
        driver.findElement(By.id("dest")).clear();
        driver.findElement(By.id("dest")).sendKeys("testSelenium@dac.com");
        driver.findElement(By.id("dest")).sendKeys(Keys.TAB, Keys.TAB,"testMessage");
        driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
        assertEquals("Message sent!", driver.findElement(By.cssSelector("div.alert.alert-success")).getText());
        ...
        assertEquals("testMessage", driver.findElement(By.xpath("//div/p")).getText());
